...
\hypersetup{
    ...
    pdftitle={Privacy-Oriented Edge-Cloud Fall Detection with Quality-Aware Bidirectional Temporal Modeling},
    pdfauthor={Jiahao Zhao, Chengyi Xu, Yaorong Huang, Zhonglin Chang, Jiayun Song},
...
\title{Privacy-Oriented Edge-Cloud Fall Detection\\
...
\input{texfiles/3.System_Overview}

\input{texfiles/4.Implementation}

\input{texfiles/4.Experiments_and_Analysis}

\input{texfiles/5.Discussion}

\input{texfiles/6.Limitations}

\input{texfiles/5.Conclusion}

% \input{texfiles/6.References}
